...
//登录
export const loginPas = (data, headcode) => fetch(getUrl('factoring/login'), data, "POSTJSON", 'application/json', headcode);
//开始融资
export const smallCreditVo = (data, headcode) => fetch(getUrl('factoring/smallCreditVo'), data, "POSTJSON", 'application/json', headcode);
//开始融资
export const applySmallCreditVo = (data, headcode) => fetch(getUrl('factoring/applySmallCreditVo'), data, "POSTJSON", 'application/json', headcode);
//我的信息
export const myInfoVo = (data, headcode) => fetch(getUrl('factoring/myInfoVo'), data, "POSTJSON", 'application/json', headcode);
//关于我们
export const aboutWo = (data, headcode) => fetch(getUrl('factoring/aboutWo'), data, "POSTJSON", 'application/json', headcode);
//
export const factoringPoolVo = (data, headcode) => fetch(getUrl('factoring/factoringPoolVo'), data, "POSTJSON", 'application/json', headcode);